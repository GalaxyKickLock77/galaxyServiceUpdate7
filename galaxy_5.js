...
async function executePrisonAutomation() {
    ...
    try {
        ...
        const userScriptContent = fsSync.readFileSync('./prison.user_5.js', 'utf8'); // Use sync version for simplicity here or await fs.readFile
